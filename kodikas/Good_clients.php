...
<div id="wrapper">
	...
	<?php
		$sql="SELECT * FROM consumer WHERE consumer.Debit=0";
		if($result=mysqli_query($conn, $sql)){
			if(mysqli_num_rows($result)!=0){
				echo "<table border=1  cellspacing=0 cellpading=0>  
						<font color=red size='4pt'>Consumers with no Debit</table></font>";
						echo "<table border=1 cellspacing=0 cellpading=0>
				...
				echo "<font color=red size='4pt'>No consumers found with no Debit.<br></font>";
			}
		}else{echo "Error<br>";}
		
		
		echo "<br>";
		$sql="SELECT * FROM company WHERE company.Debit=0";
		if($result=mysqli_query($conn, $sql)){
			if(mysqli_num_rows($result)!=0){
				echo "<table border=1  cellspacing=0 cellpading=0>  
						<font color=green size='4pt'>Companies with no Debit</table></font>";
						echo "<table border=1 cellspacing=0 cellpading=0>
				...
				echo "<font color=green size='4pt'>No companies found with no Debit.<br></font>";
			}
		}else{echo "Error<br>";}
		
		echo "<br>";
		$sql="SELECT * FROM merchant WHERE merchant.Debit=0";
		if($result=mysqli_query($conn, $sql)){
			if(mysqli_num_rows($result)!=0){
				echo "<table border=1  cellspacing=0 cellpading=0>  
						<font color=orange size='4pt'>Merchants with no Debit</table></font>";
						echo "<table border=1 cellspacing=0 cellpading=0>
				...
				echo "<font color=orange size='4pt'>No merchants found with no Debit.<br></font>";
			}
		}else{echo "Error<br>";}
		echo "<br>";
	?></b></center>
