		...
		<div id="wrappertop"></div>
			...
			<div id="wrappermiddle">
				...
				<?php
					...
					$sql="SELECT Balance,Debit FROM company WHERE company.Company_num=".$ID;
				...
				if(isset($_POST['deletebutton'])){
					if ($_POST['deletebutton']){
						$debit="SELECT Debit FROM company WHERE company.Company_num=".$ID;
						$result = mysqli_query($conn, $debit);
						$row=mysqli_fetch_assoc($result);
						
						if($row["Debit"]==0)
						{
							$sql="DELETE FROM company WHERE company.Company_num=".$ID;
							$result = mysqli_query($conn, $sql);
							if($result)
							{								
